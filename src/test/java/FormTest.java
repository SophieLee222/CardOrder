...
//        options.addArguments("--headless");
    ...
    @Test
    void shouldGiveErrorIfInorrectValues() {
        WebElement form = driver.findElement(By.cssSelector("form"));
        driver.findElement(By.cssSelector("[data-test-id='name'] input")).sendKeys("Grisha");
        driver.findElement(By.cssSelector("[data-test-id='phone'] input")).sendKeys("+796048591");
        driver.findElement(By.cssSelector("[data-test-id='agreement']")).click();
        driver.findElement(By.cssSelector("button")).click();
        String text = driver.findElement(By.cssSelector(".input__sub")).getText().trim();
